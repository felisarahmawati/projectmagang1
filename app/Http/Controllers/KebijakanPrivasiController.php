...
class KebijakanPrivasiController extends Controller
{
    public function index()
    {
        ...
        return view('user.profile.kebijakanprivasi.index', compact('keb'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        return view('user.profile.kebijakanprivasi.edit', $keb);
    }
    ...
    public function show(Request $request)
    {
        ...
        return view('user.profile.kebijakanprivasi.detail', $keb);
    }
