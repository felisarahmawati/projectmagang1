...
<div class="container mt-4 mb-4">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
                ...
                <div class="col-md-12">
                    <div class="card" style="background-color: #fff;">
                        ...
                        @csrf
                            ...
                            <div class="card mt-2">
                                <div class="card-body">
                                    <p>Bagaimana cara membayar ?</p>
                                </div>
                            </div>
                            <div class="card mt-2">
                                <div class="card-body">
                                    <p><a href="/user/bantuan/Jawaban3">Bagaimana melihat profil anda ?</a></p>
                                </div>
                            </div>
                            <div class="card mt-2">
                                <div class="card-body">
        ...
        <div class="col" style="width: 700px">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><a href="/user/profile/bantuan"><i class="bi bi-arrow-left px-2 "></i></a>Bagaimana cara membayar ?</h5>
