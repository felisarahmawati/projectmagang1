...
<div class="container mt-4 mb-4">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
                ...
                <div class="col-md-12">
                    <div class="card" style="background-color: #fff;">
                        ...
                        @csrf
                            ...
                            <div class="card">
                                <div class="card-body">
                                   <p> <a href="/user/bantuan/Jawaban1">Apa itu titipsini.com ?</a></P>
                                </div>
                            </div>
                            <div class="card mt-2">
                                <div class="card-body">
                                    <p><a href="/user/bantuan/Jawaban2">Bagaimana cara membayar ?</a></p>
                                </div>
                            </div>
                            <div class="card mt-2">
                                <div class="card-body">
                                    <p>Bagaimana melihat profil anda ?</p>
                                </div>
                            </div>
                            <div class="card mt-2">
                                <div class="card-body">
                                    <p><a href="/user/bantuan/Jawaban4">bagaimana cara pesan penitipan ?</a></p>
                                </div>
                            </div>
                            <div class="card mt-2">
                                <div class="card-body">
                                   <p> <a href="/user/bantuan/Jawaban5">Mengapa saya tidak menerima kode OTP?</a></p>
                                </div>
                            </div><br>
        ...
        <div class="col" style="width: 700px">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><a href="/user/profile/bantuan"><i class="bi bi-arrow-left px-2 "></i></a>Bagaimana melihat profile anda ?</h5>
