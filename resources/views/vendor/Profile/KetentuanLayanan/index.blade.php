...
<div class="main">
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <td class="col-md-6">Isi Ketentuan Layanan</td>
        ...
        <div class="modal-dialog modal-lg" style="width:45%">
            <div class="modal-content">
                <div class="modal-header hader">
                    <h3 class="modal-title" id="exampleModalLabel">Edit Ketentuan Layanan</h3>
    ...
    <div class="modal fade" id="exampleModalHapus{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width:45%">
            <div class="modal-content">
                ...
                <form action="{{ url('/keb/'.$data->id) }}" method="POST">
                    @method("DELETE")
                    {{ csrf_field() }}
    ...
    <div class="modal fade" id="exampleModal7" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 50%">
            <div class="modal-content">
                <div class="modal-header hader">
                    <h3 class="modal-title" id="exampleModalLabel">Tambah Ketentuan Layanan</h3>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
...
<script type="text/javascript">
    function editKebijakanPrivasi(id) {
        $.ajax({
            url: "{{ url('/user/profile/kebijakanprivasi/edit') }}",
            type: "GET",
            data: {
                id: id
            },
    ...
    function detailKebijakanPrivasi(id) {
        $.ajax({
            url: "{{ url('/user/profile/kebijakanprivasi/detail') }}",
            type: "GET",
            data: {
                id: id
            },
